...
<head>
  ...
  <style>
	...
	#opacity-screen{
	  ...
	  background-image: url('picture/bglogin.jpg');
...
<body data-spy="scroll" data-target=".navbar" data-offset="60">
	<div id="opacity-screen">
		<img id="bg-login" src="picture/bglogin.jpg">
	        		...
	        		<div id="loginform" class="form-horizontal" rule="form">
	          			...
	          			<div style="margin-top: 10px" class="form-group">
	            			<div class="center col-md-12 col-xs-12 controls">
	              				<button id="login-btn" class="btn btn-success"><i class="fa fa-sign-in"></i> Đăng Nhập</button>
	            			</div>
	          			</div>
	          			<div class="form-group">
	            			<div class="col-md-12 col-xs-12 control">
	              				<div style="border-top: 1px solid #888; padding-top: 15px; font-size: 85%" ><a href="#signupbox" onClick="$('#loginbox').hide(); $('#signupbox').show()">Đăng Ký Tài Khoản</a>
	              				</div>
		            		</div>
		          		</div>
		        	</div>
	        		...
	        		<div id="signupform" class="form-horizontal" role="form">
						...
						<div class="form-group">
						  	<div class="center col-md-12 col-xs-12 control">
						      	<button id="signup-btn" type="button" class="btn btn-danger"><i class="glyphicon glyphicon-send"></i> Đăng Ký</button>
		              		</div>
		          		</div>
						<div class="form-group">
							<div class="col-md-12 col-xs-12 control">
								<div style="border-top: 1px solid #888; padding-top: 15px; font-size: 85%" ><a href="#loginbox" onclick="$('#signupbox').hide(); $('#loginbox').show()">Đăng Nhập</a>
							  	</div>
							</div>
						</div>
	        		</div>
